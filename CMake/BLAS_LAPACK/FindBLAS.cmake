...
#      message(STATUS "BLAS_SEARCH_LIBS=${BLAS_SEARCH_LIBS}")
#      message(STATUS "${CMAKE_THREAD_LIBS_INIT};${BLAS_mkl_LM};${BLAS_mkl_LDL}")
#      message(STATUS "${_BLAS_MKLROOT_LIB_DIR}")

      foreach (IT ${BLAS_SEARCH_LIBS})
        string(REPLACE " " ";" SEARCH_LIBS ${IT})
#        message(STATUS "SEARCH_LIBS=${SEARCH_LIBS}")
        if (NOT ${_LIBRARIES})
          check_fortran_libraries(
            ${_LIBRARIES}
            BLAS
