...
find_path(MPFR_INCLUDES NAMES mpfr.h PATHS
    ENV CPATH
    ENV C_INCLUDE_PATH
    ...
    /opt/local/include
    /sw/include
    $ENV{GMPDIR} $ENV{MPFRDIR}
  DOC "Include Directory for MPFR"
)
...
target_include_directories(mpfr SYSTEM INTERFACE ${MPFR_INCLUDES})
