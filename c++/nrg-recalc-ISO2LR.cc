...
void SymmetryISO2LR::recalc_doublet(const DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
...
void SymmetryISO2LR::recalc_triplet(const DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  for(const auto &[I1, eig]: diag) {
    Ispin ii1 = I1.get("II");
    Sspin ss1 = I1.get("SS");
    int p1    = I1.get("P");
