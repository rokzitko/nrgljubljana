...
void SymmetryU1::recalc_doublet(DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  LOOP(diag, is1) {
    ...
    Number q1 = I1.get("Q");
    Invar Ip  = Invar(q1 - 1);
    ONE23(RECALC_TAB("u1/u1-1ch-doublet.dat", U1::LENGTH_D_1CH, Invar(1)), RECALC_TAB("u1/u1-2ch-doublet.dat", U1::LENGTH_D_2CH, Invar(1)),
...
void SymmetryU1::recalc_irreduc(const DiagInfo &diag) {
  LOOP_const(diag, isp) {
    ...
    Number qp = Ip.get("Q");
    Invar I1  = Invar(qp + 1);
    ONE23(RECALC_F_TAB_U1("u1/u1-1ch-a-DO.dat", 0, 1, U1::LENGTH_I_1CH); RECALC_F_TAB_U1("u1/u1-1ch-a-UP.dat", 0, 0, U1::LENGTH_I_1CH),

                                                                         RECALC_F_TAB_U1("u1/u1-2ch-a-DO.dat", 0, 1, U1::LENGTH_I_2CH);
          RECALC_F_TAB_U1("u1/u1-2ch-b-DO.dat", 1, 1, U1::LENGTH_I_2CH); RECALC_F_TAB_U1("u1/u1-2ch-a-UP.dat", 0, 0, U1::LENGTH_I_2CH);
          RECALC_F_TAB_U1("u1/u1-2ch-b-UP.dat", 1, 0, U1::LENGTH_I_2CH),

          RECALC_F_TAB_U1("u1/u1-3ch-a-DO.dat", 0, 1, U1::LENGTH_I_3CH);
          RECALC_F_TAB_U1("u1/u1-3ch-b-DO.dat", 1, 1, U1::LENGTH_I_3CH); RECALC_F_TAB_U1("u1/u1-3ch-c-DO.dat", 2, 1, U1::LENGTH_I_3CH);
          RECALC_F_TAB_U1("u1/u1-3ch-a-UP.dat", 0, 0, U1::LENGTH_I_3CH); RECALC_F_TAB_U1("u1/u1-3ch-b-UP.dat", 1, 0, U1::LENGTH_I_3CH);
...
void SymmetryU1::recalc_global(DiagInfo &diag, string name, MatrixElements &cnew) {
  if (name == "SZtot") {
    LOOP(diag, is1) {
      Invar I1          = INVAR(is1);
