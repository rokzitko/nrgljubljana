...
void SymmetrySPSU2T::recalc_doublet(const DiagInfo &diag, QSrmax &qsrmax, const MatrixElements &cold, MatrixElements &cnew) {
...
void SymmetrySPSU2T::recalc_irreduc(const DiagInfo &diag, QSrmax &qsrmax, Opch &opch) {
  my_assert(!substeps);
...
#include "spsu2t/spsu2t-spinup+1.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], Ip, I1, recalc_table, SPSU2T::LENGTH_I_3CH_0);
  }
};
...
#include "spsu2t/spsu2t-spinup0.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], Ip, I1, recalc_table, SPSU2T::LENGTH_I_3CH_1);
  }
};
...
#include "spsu2t/spsu2t-spinup-1.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], Ip, I1, recalc_table, SPSU2T::LENGTH_I_3CH_2);
  }
};
...
void SymmetrySPSU2T::recalc_triplet(const DiagInfo &diag, QSrmax &qsrmax, const MatrixElements &cold, MatrixElements &cnew) {
  for(const auto &[I1, eig]: diag) {
    Sspin ss1  = I1.get("SS");
    Tangmom t1 = I1.get("T");
    double T   = t1; // trick!
