...
#include "qst/qst-spinup+1.dat"
    ...
    recalc_f(diag, opch[0][0], Ip, I1, recalc_table, QST::LENGTH_I_3CH_0);
  }
};
...
#include "qst/qst-spinup0.dat"
    ...
    recalc_f(diag, opch[0][0], Ip, I1, recalc_table, QST::LENGTH_I_3CH_1);
  }
};
...
#include "qst/qst-spinup-1.dat"
    ...
    recalc_f(diag, opch[0][0], Ip, I1, recalc_table, QST::LENGTH_I_3CH_2);
  }
};
