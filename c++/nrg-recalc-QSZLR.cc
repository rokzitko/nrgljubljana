...
void SymmetryQSZLR::recalc_irreduc(const DiagInfo &diag, QSrmax &qsrmax, Opch &opch) {
...
#include "qszlr/qszlr-2ch-spinupa.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], Ip, I1, recalc_table, QSZLR::LENGTH_I_2CH);
  }
};
    {
...
#include "qszlr/qszlr-2ch-spinupb.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == QSZLR::LENGTH_I_2CH);
    recalc_f(diag, qsrmax, opch[1][0], Ip, I1, recalc_table, QSZLR::LENGTH_I_2CH);
  }
};
