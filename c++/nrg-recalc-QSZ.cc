...
#include "qsz/qsz-1ch-doubletp.dat"
        ...
        cnew[II] = this->recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ARRAYLENGTH(recalc_table), Invar(1, -1));
...
#include "qsz/qsz-1ch-triplets.dat"
        ...
        cnew[II] = this->recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ARRAYLENGTH(recalc_table), Invar(0, 0));
      }(); // immediately executed lambda
    }
  }
} } break;
...
#include "qsz/qsz-1ch-tripletp.dat"
        ...
        cnew[II] = this->recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ARRAYLENGTH(recalc_table), Invar(0, -2));
      }(); // immediately executed lambda
    }
  }
} } break;
