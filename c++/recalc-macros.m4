...
#include $1
    ...
    recalc_general(diag, cold, cnew, I1, Ip, recalc_table, $2, $3);
  }
})
              ...
              default: my_assert_not_reached();
               ...
               define(`ONE234', switch (channels) {
                 ...
                 default: my_assert_not_reached();
                  ...
                  define(`ONE2345', switch (channels) {
                    case 1: {
                      $1
                    } break;
                    case 2: {
