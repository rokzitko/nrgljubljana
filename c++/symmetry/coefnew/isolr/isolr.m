...
PREFIX = "isolr-" <> ToString[channels] <> "ch";
fnprep[];
...
basis = transformtoLRvc[basis, basisops, vacuum[]];
...
simpl4[expr_] := simplNN[expr, rules4] /. rule;
...
irrule[opiz_, opsz_, opp_] = {S -> S + opsz, Sz -> Sz + opsz,
