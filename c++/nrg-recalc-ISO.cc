...
#include "iso/iso-1ch-spinup-isoupa.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], I1, Ip, recalc_table, ISO1::LENGTH_I_1CH);
  }
} } break;
  case 2: { {
...
#include "iso/iso-2ch-spinup-isoupa.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], I1, Ip, recalc_table, ISO1::LENGTH_I_2CH);
  }
};
	   {
...
#include "iso/iso-2ch-spinup-isoupb.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO1::LENGTH_I_2CH);
    recalc_f(diag, qsrmax, opch[1][0], I1, Ip, recalc_table, ISO1::LENGTH_I_2CH);
  }
} } break;
  case 3: { {
...
#include "iso/iso-3ch-spinup-isoupa.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], I1, Ip, recalc_table, ISO1::LENGTH_I_3CH_0);
  }
};
	   {
...
#include "iso/iso-3ch-spinup-isoupb.dat"
    ...
    recalc_f(diag, qsrmax, opch[1][0], I1, Ip, recalc_table, ISO1::LENGTH_I_3CH_1);
  }
};
	   {
...
#include "iso/iso-3ch-spinup-isoupc.dat"
    ...
    recalc_f(diag, qsrmax, opch[2][0], I1, Ip, recalc_table, ISO1::LENGTH_I_3CH_2);
  }
} } break;
  default: my_assert_not_reached();
  };
