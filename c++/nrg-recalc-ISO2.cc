...
void SymmetryISO2::recalc_doublet(DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  LOOP(diag, is1) {
    Invar I1  = INVAR(is1);
    Ispin ii1 = I1.get("II");
    Sspin ss1 = I1.get("SS");
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC(fn="
                    << "iso2/iso2-1ch-doubletmp.dat"
                    << ", len=" << ISO2::LENGTH_D_1CH << ", Iop=" << Invar(2, 2) << ")");
          if (diag.count(Ip)) {
            struct Recalc recalc_table[] = {
#include "iso2/iso2-1ch-doubletmp.dat"
            };
            BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_D_1CH);
            recalc_general(diag, cold, cnew, I1, Ip, recalc_table, ISO2::LENGTH_D_1CH, Invar(2, 2));
          }
        }
      } break;
      case 2: {
        {
          nrglog('f',
                 "RECALC(fn="
                    << "iso2/iso2-2ch-doubletmp.dat"
                    << ", len=" << ISO2::LENGTH_D_2CH << ", Iop=" << Invar(2, 2) << ")");
          if (diag.count(Ip)) {
            struct Recalc recalc_table[] = {
#include "iso2/iso2-2ch-doubletmp.dat"
            };
            BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_D_2CH);
            recalc_general(diag, cold, cnew, I1, Ip, recalc_table, ISO2::LENGTH_D_2CH, Invar(2, 2));
          }
        }
      } break;
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-1ch-spinup-isoupa.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_1CH << ")");
          if (diag.count(I1)) {
      ...
      case 2: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spinup-isoupa.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
#include "iso2/iso2-2ch-spinup-isoupa.dat"
        ...
        };
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spinup-isoupb.dat"
                    << ", ch=" << 1 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-1ch-spindown-isoupa.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_1CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
      ...
      case 2: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spindown-isoupa.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
#include "iso2/iso2-2ch-spindown-isoupa.dat"
        ...
        };
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spindown-isoupb.dat"
                    << ", ch=" << 1 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-1ch-spinup-isodowna.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_1CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
      ...
      case 2: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spinup-isodowna.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
#include "iso2/iso2-2ch-spinup-isodowna.dat"
        ...
        };
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spinup-isodownb.dat"
                    << ", ch=" << 1 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-1ch-spindown-isodowna.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_1CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
      ...
      case 2: {
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spindown-isodowna.dat"
                    << ", ch=" << 0 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
#include "iso2/iso2-2ch-spindown-isodowna.dat"
        ...
        };
        {
          nrglog('f',
                 "RECALC_F(fn="
                    << "iso2/iso2-2ch-spindown-isodownb.dat"
                    << ", ch=" << 1 << ", len=" << ISO2::LENGTH_I_2CH << ")");
          if (diag.count(I1)) {
            struct Recalc_f recalc_table[] = {
...
void SymmetryISO2::recalc_triplet(DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  LOOP(diag, is1) {
    Invar I1  = INVAR(is1);
    Ispin ii1 = I1.get("II");
    Sspin ss1 = I1.get("SS");
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC(fn="
                    << "iso2/iso2-1ch-triplets.dat"
                    << ", len=" << ISO2::LENGTH_T0_1CH << ", Iop=" << Invar(1, 3) << ")");
          if (diag.count(Ip)) {
            struct Recalc recalc_table[] = {
#include "iso2/iso2-1ch-triplets.dat"
            };
            BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_T0_1CH);
            recalc_general(diag, cold, cnew, I1, Ip, recalc_table, ISO2::LENGTH_T0_1CH, Invar(1, 3));
          }
        }
      } break;
      case 2: {
        {
          nrglog('f',
                 "RECALC(fn="
                    << "iso2/iso2-2ch-triplets.dat"
                    << ", len=" << ISO2::LENGTH_T0_2CH << ", Iop=" << Invar(1, 3) << ")");
          if (diag.count(Ip)) {
            struct Recalc recalc_table[] = {
#include "iso2/iso2-2ch-triplets.dat"
            };
            BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_T0_2CH);
            recalc_general(diag, cold, cnew, I1, Ip, recalc_table, ISO2::LENGTH_T0_2CH, Invar(1, 3));
          }
        }
      } break;
      default: my_assert_not_reached();
      ...
      case 1: {
        {
          nrglog('f',
                 "RECALC(fn="
                    << "iso2/iso2-1ch-tripletp.dat"
                    << ", len=" << ISO2::LENGTH_Tpm_1CH << ", Iop=" << Invar(1, 3) << ")");
          if (diag.count(Ip)) {
            struct Recalc recalc_table[] = {
#include "iso2/iso2-1ch-tripletp.dat"
            };
            BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_Tpm_1CH);
            recalc_general(diag, cold, cnew, I1, Ip, recalc_table, ISO2::LENGTH_Tpm_1CH, Invar(1, 3));
          }
        }
      } break;
      case 2: {
        {
          nrglog('f',
                 "RECALC(fn="
                    << "iso2/iso2-2ch-tripletp.dat"
                    << ", len=" << ISO2::LENGTH_Tpm_2CH << ", Iop=" << Invar(1, 3) << ")");
          if (diag.count(Ip)) {
            struct Recalc recalc_table[] = {
#include "iso2/iso2-2ch-tripletp.dat"
            };
            BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_Tpm_2CH);
            recalc_general(diag, cold, cnew, I1, Ip, recalc_table, ISO2::LENGTH_Tpm_2CH, Invar(1, 3));
          }
        }
      } break;
      default: my_assert_not_reached();
