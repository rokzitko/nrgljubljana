...
#include "iso2/iso2-1ch-spinup-isoupa.dat"
    ...
    recalc_f(diag, iterinfo.opch[0][0], Ip, I1, recalc_table, ISO2::LENGTH_I_1CH);
  }
} } break;
  case 2: { {
...
#include "iso2/iso2-2ch-spinup-isoupa.dat"
    ...
    recalc_f(diag, iterinfo.opch[0][0], Ip, I1, recalc_table, ISO2::LENGTH_I_2CH);
  }
};
     	    {
...
#include "iso2/iso2-2ch-spinup-isoupb.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISO2::LENGTH_I_2CH);
    recalc_f(diag, iterinfo.opch[1][0], Ip, I1, recalc_table, ISO2::LENGTH_I_2CH);
  }
} } break;
  default: my_assert_not_reached();
  };
