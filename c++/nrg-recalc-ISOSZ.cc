...
#include "isosz/isosz-1ch-doubletmp.dat"
    ...
    cnew[Twoinvar(I1, Ip)] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZ::LENGTH_D_1CH, Invar(2, -1));
  }
} } break;
  case 2: { {
...
#include "isosz/isosz-2ch-doubletmp.dat"
    ...
    cnew[Twoinvar(I1, Ip)] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZ::LENGTH_D_2CH, Invar(2, -1));
  }
} } break;
...
#include "isosz/isosz-1ch-spinup-isoupa.dat"
    ...
    opch[0][0][Twoinvar(I1,Ip)] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOSZ::LENGTH_I_1CH);
  }
} } break;
  case 2: { {
...
#include "isosz/isosz-2ch-spinup-isoupa.dat"
    ...
    opch[0][0][Twoinvar(I1,Ip)] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOSZ::LENGTH_I_2CH);
  }
};
	    {
...
#include "isosz/isosz-2ch-spinup-isoupb.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISOSZ::LENGTH_I_2CH);
    opch[1][0][Twoinvar(I1,Ip)] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOSZ::LENGTH_I_2CH);
  }
} } break;
  default: my_assert_not_reached();
  };
...
#include "isosz/isosz-1ch-triplets.dat"
    ...
    cnew[Twoinvar(I1, Ip)] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZ::LENGTH_T0_1CH, Invar(1, 0));
  }
} } break;
  case 2: { {
...
#include "isosz/isosz-2ch-triplets.dat"
    ...
    cnew[Twoinvar(I1, Ip)] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZ::LENGTH_T0_2CH, Invar(1, 0));
  }
} } break;
  default: my_assert_not_reached();
  };
...
#include "isosz/isosz-1ch-tripletp.dat"
    ...
    cnew[Twoinvar(I1, Ip)] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZ::LENGTH_Tpm_1CH, Invar(1, -2));
  }
} } break;
  case 2: { {
...
#include "isosz/isosz-2ch-tripletp.dat"
    ...
    cnew[Twoinvar(I1, Ip)] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZ::LENGTH_Tpm_2CH, Invar(1, -2));
  }
} } break;
  default: my_assert_not_reached();
  };
