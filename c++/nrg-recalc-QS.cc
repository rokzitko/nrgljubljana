...
void SymmetryQS::recalc_doublet(DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  if (!substeps) {
    LOOP(diag, is1) {
      ...
      Ip = Invar(q1 - 1, ss1 + 1);
      ONE234(RECALC_TAB("qs/qs-1ch-doubletp.dat", QS::LENGTH_D_1CH, Invar(1, 2)), RECALC_TAB("qs/qs-2ch-doubletp.dat", QS::LENGTH_D_2CH, Invar(1, 2)),
             RECALC_TAB("qs/qs-3ch-doubletp.dat", QS::LENGTH_D_3CH, Invar(1, 2)),
             RECALC_TAB("qs/qs-4ch-doubletp.dat", QS::LENGTH_D_4CH, Invar(1, 2)));

      Ip = Invar(q1 - 1, ss1 - 1);
      ONE234(RECALC_TAB("qs/qs-1ch-doubletm.dat", QS::LENGTH_D_1CH, Invar(1, 2)), RECALC_TAB("qs/qs-2ch-doubletm.dat", QS::LENGTH_D_2CH, Invar(1, 2)),
...
void SymmetryQS::recalc_irreduc(const DiagInfo &diag) {
  ...
  LOOP_const(diag, isp) {
    ...
    ONE234(RECALC_F_TAB("qs/qs-1ch-spinupa.dat", 0, QS::LENGTH_I_1CH),
           ...
           RECALC_F_TAB("qs/qs-3ch-spinupb.dat", 1, QS::LENGTH_I_3CH_1); RECALC_F_TAB("qs/qs-3ch-spinupc.dat", 2, QS::LENGTH_I_3CH_2),

                                                                         RECALC_F_TAB("qs/qs-4ch-spinupa.dat", 0, QS::LENGTH_I_4CH_0);
           RECALC_F_TAB("qs/qs-4ch-spinupb.dat", 1, QS::LENGTH_I_4CH_1); RECALC_F_TAB("qs/qs-4ch-spinupc.dat", 2, QS::LENGTH_I_4CH_2);
    ...
    ONE234(RECALC_F_TAB("qs/qs-1ch-spindowna.dat", 0, QS::LENGTH_I_1CH),
           ...
           RECALC_F_TAB("qs/qs-3ch-spindownb.dat", 1, QS::LENGTH_I_3CH_1); RECALC_F_TAB("qs/qs-3ch-spindownc.dat", 2, QS::LENGTH_I_3CH_2),

                                                                           RECALC_F_TAB("qs/qs-4ch-spindowna.dat", 0, QS::LENGTH_I_4CH_0);
           RECALC_F_TAB("qs/qs-4ch-spindownb.dat", 1, QS::LENGTH_I_4CH_1); RECALC_F_TAB("qs/qs-4ch-spindownc.dat", 2, QS::LENGTH_I_4CH_2);
...
void SymmetryQS::recalc_triplet(DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  if (!substeps) {
    LOOP(diag, is1) {
      ...
      Ip = Invar(q1, ss1);
      ONE234(
         RECALC_TAB("qs/qs-1ch-triplets.dat", QS::LENGTH_T0_1CH, Invar(0, 3)), RECALC_TAB("qs/qs-2ch-triplets.dat", QS::LENGTH_T0_2CH, Invar(0, 3)),
         RECALC_TAB("qs/qs-3ch-triplets.dat", QS::LENGTH_T0_3CH, Invar(0, 3)), RECALC_TAB("qs/qs-4ch-triplets.dat", QS::LENGTH_T0_4CH, Invar(0, 3)));
