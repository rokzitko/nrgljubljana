...
#include "qs/qs-4ch-spinupd.dat"
        ...
        opch[3][0][II] = this->recalc_f(diag, qsrmax, I1, Ip, recalc_table, ARRAYLENGTH(recalc_table));
      }();
    }
  }
} } break;
...
#include "qs/qs-1ch-triplets.dat"
        ...
        cnew[II] = this->recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ARRAYLENGTH(recalc_table), Invar(0, 3));
      }(); // immediately executed lambda
    }
  }
} } break;
