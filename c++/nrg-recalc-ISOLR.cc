...
#include "isolr/isolr-2ch-spinup-isoupa.dat"
      ...
      opch[0][0][II] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOLR::LENGTH_I_2CH);
    } else {
...
#include "isolr/isolr-2ch-spinup-isoupb.dat"
      ...
      BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISOLR::LENGTH_I_2CH);
      opch[1][0][II] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOLR::LENGTH_I_2CH);
    } else {
...
#include "isolr/isolr-2ch-doubletmp.dat"
      ...
      cnew[II] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOLR::LENGTH_D_2CH, Invar(2, 2, +1));
    } else {
      cnew[II] = Matrix(0,0); // ???
    }
  }
...
#include "isolr/isolr-2ch-triplets.dat"
      ...
      cnew[II] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOLR::LENGTH_T0_2CH, Invar(1, 3, +1));
    } else {
      cnew[II] = Matrix(0,0); // ???
    }
  }
...
#include "isolr/isolr-2ch-tripletp.dat"
      ...
      cnew[II] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOLR::LENGTH_Tpm_2CH, Invar(1, 3, +1));
    } else {
      cnew[II] = Matrix(0,0); // ???
    }
  }
