...
void SymmetryQSC3::recalc_irreduc(const DiagInfo &diag, QSrmax &qsrmax, Opch &opch) {
#ifdef NRG_COMPLEX
...
#include "qsc3/qsc3-spinup0-a.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], Ip, I1, recalc_table, QSC3::LENGTH_I_3CH);
  }
};
    {
...
#include "qsc3/qsc3-spinup0-b.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == QSC3::LENGTH_I_3CH);
    recalc_f(diag, qsrmax, opch[1][0], Ip, I1, recalc_table, QSC3::LENGTH_I_3CH);
  }
};
    {
...
#include "qsc3/qsc3-spinup0-c.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == QSC3::LENGTH_I_3CH);
    recalc_f(diag, qsrmax, opch[2][0], Ip, I1, recalc_table, QSC3::LENGTH_I_3CH);
  }
};
...
void SymmetryQSC3::recalc_doublet(const DiagInfo &diag, QSrmax &qsrmax, const MatrixElements &cold, MatrixElements &cnew) {
#ifdef NRG_COMPLEX
...
void SymmetryQSC3::recalc_triplet(const DiagInfo &diag, QSrmax &qsrmax, const MatrixElements &cold, MatrixElements &cnew) {
#ifdef NRG_COMPLEX
  for(const auto &[I1, eig]: diag) {
    Number q1 = I1.get("Q");
    Sspin ss1 = I1.get("SS");
