...
#include "qsc3/qsc3-spinup0-a.dat"
    ...
    recalc_f(diag, qsrmax, opch[0][0], I1, Ip, recalc_table, QSC3::LENGTH_I_3CH);
  }
};
    {
...
#include "qsc3/qsc3-spinup0-b.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == QSC3::LENGTH_I_3CH);
    recalc_f(diag, qsrmax, opch[1][0], I1, Ip, recalc_table, QSC3::LENGTH_I_3CH);
  }
};
    {
...
#include "qsc3/qsc3-spinup0-c.dat"
    ...
    BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == QSC3::LENGTH_I_3CH);
    recalc_f(diag, qsrmax, opch[2][0], I1, Ip, recalc_table, QSC3::LENGTH_I_3CH);
  }
};
