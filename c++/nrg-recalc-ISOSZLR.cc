...
#include "isoszlr/isoszlr-2ch-spinup-isoupa.dat"
      ...
      opch[0][0][II] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOSZLR::LENGTH_I_2CH);
    } else {
...
#include "isoszlr/isoszlr-2ch-spinup-isoupb.dat"
      ...
      BOOST_STATIC_ASSERT(ARRAYLENGTH(recalc_table) == ISOSZLR::LENGTH_I_2CH);
      opch[1][0][II] = recalc_f(diag, qsrmax, I1, Ip, recalc_table, ISOSZLR::LENGTH_I_2CH);
    } else {
...
#include "isoszlr/isoszlr-2ch-doubletmp.dat"
      ...
      cnew[II] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZLR::LENGTH_D_2CH, Invar(2, -1, +1));
    } else {
      cnew[II] = Matrix(0,0); // ???
    }
  }
...
#include "isoszlr/isoszlr-2ch-triplets.dat"
      ...
      cnew[II] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZLR::LENGTH_T0_2CH, Invar(1, 0, +1));
    } else {
      cnew[II] = Matrix(0,0); // ???
    }
  }
...
#include "isoszlr/isoszlr-2ch-tripletp.dat"
      ...
      cnew[II] = recalc_general(diag, qsrmax, cold, I1, Ip, recalc_table, ISOSZLR::LENGTH_Tpm_2CH, Invar(1, -2, +1));
    } else {
      cnew[II] = Matrix(0,0); // ???
    }
  }
