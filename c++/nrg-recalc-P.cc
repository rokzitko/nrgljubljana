...
void SymmetryP::recalc_irreduc(const DiagInfo &diag) {
  LOOP_const(diag, isp) {
    ...
    ONETWO(RECALC_F_TAB_P("p/p-1ch-a-CR-DO.dat", 0, 0, P::LENGTH_I_1CH); RECALC_F_TAB_P("p/p-1ch-a-CR-UP.dat", 0, 1, P::LENGTH_I_1CH);
           RECALC_F_TAB_P("p/p-1ch-a-AN-DO.dat", 0, 2, P::LENGTH_I_1CH); RECALC_F_TAB_P("p/p-1ch-a-AN-UP.dat", 0, 3, P::LENGTH_I_1CH);
           , RECALC_F_TAB_P("p/p-2ch-a-CR-DO.dat", 0, 0, P::LENGTH_I_2CH); RECALC_F_TAB_P("p/p-2ch-b-CR-DO.dat", 1, 0, P::LENGTH_I_2CH);
           RECALC_F_TAB_P("p/p-2ch-a-CR-UP.dat", 0, 1, P::LENGTH_I_2CH); RECALC_F_TAB_P("p/p-2ch-b-CR-UP.dat", 1, 1, P::LENGTH_I_2CH);
           RECALC_F_TAB_P("p/p-2ch-a-AN-DO.dat", 0, 2, P::LENGTH_I_2CH); RECALC_F_TAB_P("p/p-2ch-b-AN-DO.dat", 1, 2, P::LENGTH_I_2CH);
           RECALC_F_TAB_P("p/p-2ch-a-AN-UP.dat", 0, 3, P::LENGTH_I_2CH); RECALC_F_TAB_P("p/p-2ch-b-AN-UP.dat", 1, 3, P::LENGTH_I_2CH));
  }
}
...
void SymmetryP::recalc_doublet(DiagInfo &diag, MatrixElements &cold, MatrixElements &cnew) {
  LOOP(diag, is1) {
    ...
    ONETWO(RECALC_TAB("p/p-1ch-doublet.dat", P::LENGTH_D_1CH, Invar(-1)), RECALC_TAB("p/p-2ch-doublet.dat", P::LENGTH_D_2CH, Invar(-1)));
  }
}
