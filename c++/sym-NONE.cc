...
void SymmetryNONE::makematrix_nonpolarized(Matrix &h, const Rmaxvals &qq,
                              const Invar &I, const InvarVec &In)
{
  switch (channels) {
  case 1:
...
void SymmetryNONE::makematrix_polarized(Matrix &h, const Rmaxvals &qq,
					const Invar &I, const InvarVec &In)
{
  switch (channels) {
  case 1:
...
void SymmetryNONE::makematrix(Matrix &h, const Rmaxvals &qq,
			      const Invar &I, const InvarVec &In)
{
   if (P::polarized) {
