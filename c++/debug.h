...
#define nrgdump2(STR1, STR2) cout << #STR1 << "=" << (STR1) << " " << #STR2 << "=" << (STR2) << " "

#define nrgdump3(STR1, STR2, STR3) cout << #STR1 << "=" << (STR1) << " " << #STR2 << "=" << (STR2) << " " << #STR3 << "=" << (STR3) << " "

#define nrgdump4(STR1, STR2, STR3, STR4)                                                                                                             \
  cout << #STR1 << "=" << (STR1) << " " << #STR2 << "=" << (STR2) << " " << #STR3 << "=" << (STR3) << " " << #STR4 << "=" << (STR4) << " "

#define nrgdump5(STR1, STR2, STR3, STR4, STR5)                                                                                                       \
  cout << #STR1 << "=" << (STR1) << " " << #STR2 << "=" << (STR2) << " " << #STR3 << "=" << (STR3) << " " << #STR4 << "=" << (STR4) << " " << #STR5  \
       << "=" << (STR5) << " "
