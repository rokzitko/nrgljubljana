...
{
       0,     0,     3,     6,    10,    14,    16,    18,    20,    22,
      23,    27,    31,    35,    39,    42,    46,    48,    50,    52,
      57,    62,    67,    74,    81,    83,    87,    90,    94,    96,
     100,   105
};
...
{
      27,     0,    -1,    28,    18,    -1,    27,    28,    18,    -1,
       4,    19,    29,    -1,    29,    -1,    31,    -1,    33,    -1,
      14,    -1,    -1,    29,     8,    29,    -1,    29,     7,    29,
      -1,    29,     9,    29,    -1,    29,    10,    29,    -1,     7,
      29,    -1,    20,    29,    21,    -1,     5,    -1,     6,    -1,
       4,    -1,     4,    20,    29,    21,    -1,     4,    22,    29,
      23,    -1,    15,    22,     6,    23,    -1,    17,    22,     6,
      11,     6,    23,    -1,    16,    22,     6,    11,     6,    23,
      -1,    29,    -1,    29,    11,    30,    -1,    24,    25,    -1,
      24,    30,    25,    -1,    31,    -1,    31,    11,    32,    -1,
      24,    24,    25,    25,    -1,    24,    32,    25,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    66,    66,    67,    70,    76,    77,    78,    79,    83,
      86,    87,    88,    89,    95,    96,    97,    98,    99,   100,
     108,   118,   119,   120,   123,   128,   136,   137,   140,   145,
     153,   154
};
#endif
...
static const char *const yytname[] =
{
  ...
  "expression", "expressionlist", "vector", "vectorlist", "matrix", 0
};
#endif
...
#line 70 "parser.yy"
    {
                   if (veryverbose) {
		     cerr << "Defining " << (yyvsp[(1) - (3)].symp)->name << "=" << (yyvsp[(3) - (3)].dval) << endl;
		   }
...
/* Line 1806 of yacc.c  */
#line 77 "parser.yy"
    { OUT << prefix; dump_vector((yyvsp[(1) - (1)].dvec)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 78 "parser.yy"
    { OUT << prefix; dump_matrix((yyvsp[(1) - (1)].dmat)); }
    break;
